      ...
      <div className="bg-white p-8 rounded-lg shadow-lg max-w-md w-full transform transition-transform hover:scale-105">
        ...
        <div className="mt-6">
          ...
          <input
            ...
            required
            className="w-full px-4 py-2 rounded-md border-2 border-neutral-500 bg-gray-200 text-gray-800 placeholder-gray-400 focus:ring focus:ring-opacity-50 focus:outline-none"
          />
        </div>
        <button
          onClick={() => {
