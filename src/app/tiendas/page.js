...
export default function Tiendas() {
    ...
    const data = [
    { 'Nombre': 'Oxxo CEM', 'Dirección': 'Av Lago de Guadalupe KM 3.5, Margarita Maza de Juárez, 52926 Cd López Mateos, Méx.', 'Encargado': 'Neil Sims',},
    { 'Nombre': 'Oxxo CCM', 'Dirección': 'Prol. Canal de Miramontes, Coapa, San Bartolo el Chico, Tlalpan, 14380 Ciudad de México, CDMX', 'Encargado': 'Bonnie Green',},
    { 'Nombre': 'Oxxo Campus Monterrey', 'Dirección': 'Av. Eugenio Garza Sada 2501 Sur, Tecnológico, 64849 Monterrey, N.L.', 'Encargado': 'Jese Leos', },
];
