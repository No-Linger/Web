...
const navigation = [
  { name: 'Planogramas', href: '#', current: false },
                ...
                <div className="hidden md:block">
                  <div className="ml-4 flex items-center md:ml-6">
                    ...
                    <Menu as="div" className="relative ml-3">
                      ...
                      >
                        <Menu.Items data-testid = "profile-menu"className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white dark:bg-gray-800 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
