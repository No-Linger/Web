...
import States from '@/mexico.json'
...
export default function Personas() {
  ...
  const getUserData = async()=>{
    axios.get(`${NEXT_PUBLIC_API_URL}/getUser`, 
    {
      ...
      SetUserData(res.data.user.Nombre)
    }).catch((err)=>{
      console.log(err)
    }) 
  }
      ...
      <div className="min-h-screen bg-gray-100 dark:bg-gray-700">
        ...
        <main>
          ...
          <header className="mb-10">
                <h1 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-gray-300">¡Bienvenido, {userData}!</h1>
                  ...
                  <div className="flex min-h-full items-center justify-center p-4 text-center">
                    ...
                    >
                      ...
                      <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white dark:bg-gray-800 p-6 text-left align-middle shadow-xl transition-all">
                        ...
                        <div className="w-full">
                          <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Numero telefonico</label>
                            <input type="text" id="default-input"
